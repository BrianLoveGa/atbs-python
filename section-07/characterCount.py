import pprint # - built in in py2 - import to use in py 3

message = 'It was a bright cold day in April and the clocks were striking thirteen.'
# message = input() # you try type and it'll count it up
count={}
...
# lets get crazy with some shakespeare

romeo = """The Project Gutenberg EBook of Romeo and Juliet, by William Shakespeare
